...
-- basket-prep social ahead of the ball moved to October 3.
--
-- This renames the seeded "Tartan Ball Basket-Making Happy Hour" (Oct 17) to
-- "Tartan Ball Basket Social" and moves it to 2026-10-03 18:00 Eastern. The
-- name keeps the word "Basket" so the Tartan Ball ticket-link special-casing
-- on the public pages continues to leave this event alone. RSVP details are
...
UPDATE public.events
   SET name = 'Tartan Ball Basket Social',
       ...
       external_url = NULL,
       notes = 'NEW DATE: moved from October 17 to October 3. Socialize with fellow Krewe members while preparing raffle baskets for the Tartan Ball. RSVP details are in the all-krewe email.'
...
BEGIN
  IF EXISTS (
    ...
    UPDATE public.events
       SET description = 'Come help us put everything together! The Basket Social is a fun opportunity to socialize with fellow Krewe members while preparing baskets for the big night. NEW DATE: Saturday, October 3.'
