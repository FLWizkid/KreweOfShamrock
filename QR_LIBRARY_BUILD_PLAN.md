...
| 1 | Export + commit the missing `kos_parade_ready_engine` / `kos_checkin_codes_private` migrations to `sql/` | database access | done 2026-09-19 — full engine exported verbatim to `sql/kos_checkin_engine_export.sql` via the Supabase connection |
